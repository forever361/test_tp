...
from app.view import user,data_test, batch, testcase, compare, normal_compare, web_testcase, web_test_compare, \
    ...
    data_connect_management,data_job_management,api_new,access_config,docs,api_batch,api_batch_opp,admin,data_per_test_case
...
app.register_blueprint(data_per_test_case.web)
