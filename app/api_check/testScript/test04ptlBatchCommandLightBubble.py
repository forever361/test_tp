...
case_sheet = readConfig.GetConfig().case_ptl_batchCommandLightBubble    # 取得excel的sheet名
case_xls = readExcel.ReadExcel().get_xls(test_case_file, case_sheet)

@paramunittest.parametrized(*case_xls)
class test_ptl_batch_command_light_bubble(unittest.TestCase):
    ...
    def checkResult(self):  # 断言
        ...
        print('【url】', url)
        r = requestResult.run(self.method, url, self.headers, json.dumps(self.param))
...
if __name__ == '__main__':
    test_ptl_batch_command_light_bubble().run()
