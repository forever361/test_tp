...
def xh_avg():
    with open(basepath + "/Report/Page2_res_time.csv",'r') as csvfile:
        ...
        av = 'response_time:'+ str(int(avg))
        av1 = 'xxx:' + str(int(avg1))
        av2 = 'xxx:' + str(int(avg2))
        av3 = 'xxx:' + str(int(avg3))
        list = [av, av1, av2, av3]
        # avg4 = FFF / row_s
        print("avg:::::",avg,avg1,avg2,avg3)
        return list
...
class MyTestSuite(BaseCase):
    ...
    def test_case_CustomerProfiles(self,user,password,PanelT,Cus1,Cus2,Cusname,CusAr,CusArp,TRBB,AUDD,TRBBIn1,TRBBIn2,TMDti1,TMDti2,TMDti3,Cusla1,Cusla2,Currca,Fundf,
        ...
        print("页面加载响应时间：",Page2_onload_time)
        ...
        print("退出Page响应时间：",Exit_res_time)
        ...
        with open(basepath + "/Report/Page2_res_time.csv", "a", newline='') as f:
            ...
            csv_writer.writerow([Page2_onload_time,Ser_res_time,Ser2_res_time,Exit_res_time])
