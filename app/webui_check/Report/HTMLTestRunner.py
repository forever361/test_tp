...
<a class="abstract detail_button" href='javascript:showCase(0,%(channel)s)'>Summary[%(Pass_p).2f%%]</a>
<a class="passed  detail_button" href='javascript:showCase(1,%(channel)s)'>Pass[%(Pass)s]</a>
<a class="failed  detail_button" href='javascript:showCase(2,%(channel)s)'>Failure[%(fail)s]</a>
<a class="errored  detail_button" href='javascript:showCase(3,%(channel)s)'>Error[%(error)s]</a>
<a class="skiped  detail_button"  href='javascript:showCase(4,%(channel)s)'>Skip[%(skip)s]</a>
<a class="all detail_button" href='javascript:showCase(5,%(channel)s)'>All[%(total)s]</a>
</div>
...
"""  # variables: (id, output)
    ...
    IMG_TMPL = r"""
        <a  onfocus='this.blur();' href="javascript:void(0);" onclick="show_img(this)">show screenshot</a>
...
class HTMLTestRunner(Template_mixin):
    ...
    def getReportAttributes(self, result):
        ...
        if total>0:
            ...
            passed =0.0
        status.append(u'<span class="tj">Passing rate</span>:%.1f%%' % passed)
        if status:
