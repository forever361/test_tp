...
function get_test_case_detail(id){
  ...
  dataType: dataType
    ...
    oTableInit.Init = function () {
        $('#tb_test_cases_data_f2t').bootstrapTable({
            url: '/data_test_case_f2t.json',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                        var a = '<a href="javascript:;" onclick="window.location.href=(\'/data_edit_test_case_f2t?id='+ row.id + '\')">EDIT</a> ';
...
function searchTestCase(test_case_id){
    var $tb_departments = $('#tb_test_cases_data_f2t');
    $tb_departments.bootstrapTable('refresh', {url: '/data_test_case_f2t.json',data:{id: test_case_id,type:"test_case"}});
}
