...
function submitAddForm() {
   $("#new_test_case1").validate();
   $.validator.setDefaults({
        submitHandler: function() {
            document.getElementById("new_test_case1").submit();
    }
});
   }
        ...
        $('#tb_test_cases').bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row, index) {
                        var a = '<a href="javascript:;" onclick="window.location.href=(\'/edit_test_case?id='+ row.id + '\')">EDIT</a> ';
                        //var b = '<a href="javascript:;" onclick="copy_test_case(\'' + row.id + '\')">复制</a> ';
//                        var c = '<a href="javascript:;" onclick="run_test_case(\'' + row.id + '\')">执行</a> ';
                        var d = '<a href="javascript:;" onclick="window.location.href=(\'/test_case_runhistory?id='+ row.id + '\')">RESULT</a> ';
                        var e = '<a href="javascript:;" onclick="delete_test_case(\'' + row.id + '\')">DELETE</a> ';
                        return a+d+e;
                        }
                }
                ]
