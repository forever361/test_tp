...
if __name__ == '__main__':
    ...
    socketio.run(app,host='0.0.0.0', port=8889,allow_unsafe_werkzeug=True,ssl_context=("chinadataplatform_cds_dev_ali_cloud_cn_hsbc.pem","chinadataplatform_cds_dev_ali_cloud_cn_hsbc.key"))
