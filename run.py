...
if __name__ == '__main__':
    ...
    # socketio.run(app,host='localhost', port=8889,allow_unsafe_werkzeug=True,ssl_context=('./aixint.cn_bundle.pem', './aixint.cn.key'))
    socketio.run(app, host='127.0.0.1', port=8889, allow_unsafe_werkzeug=True)
